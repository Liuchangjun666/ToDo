...
//#import "AFHTTPRequestOperationManager+Synchronous.h"AFHTTPRequestOperationManager
...
- (NSDate *)serverDate {
    ...
    NSDictionary *responseObject = [session syncGET:kLeanCloudServerDateApiUrl parameters:parameters task:nil error:&error];
